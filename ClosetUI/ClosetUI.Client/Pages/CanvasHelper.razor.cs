...
public partial class CanvasHelper : ComponentBase, IAsyncDisposable
{
    ...
    /// <summary>
    /// Event called on mouse wheel
    /// </summary>
    [Parameter]
    public EventCallback<CanvasWheelArgs> MouseWheel { get; set; }
    ...
    /// <summary>
    /// Handle the JavaScript window.wheel event
    /// </summary>
    /// <param name="args"></param>
    /// <returns></returns>
    [JSInvokable]
    public async Task OnMouseWheel(CanvasWheelArgs args)
    {
